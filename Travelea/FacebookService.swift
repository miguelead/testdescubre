...
class FacebookLoginService {
    ...
    class func userIsFacebookLoggedIn() -> Bool{
    ...
    class func getFacebookPermission(from view: UIViewController!, permissionEvent permissionGood: @escaping ((facebookPermissionStatus)-> Void), PermissionError: @escaping ((facebookPermissionErrorStatus)-> Void)){
    ...
    class func getFacebookData(succesful goodEvent: @escaping (([String: Any])-> Void), error errorEvent: @escaping (()-> Void)){
        if FBSDKAccessToken.current() != nil{
